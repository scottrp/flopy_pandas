...
class MFSimulationData:
    ...
    def __init__(self, path: Union[str, os.PathLike], mfsim):
        ...
        self.data_offset_location = {}
        self.pandas_support = True
...
class MFSimulation(PackageContainer):
    ...
    def load(
        ...
        instance.simulation_data.pandas_support = pandas_support
        ...
        # read data offset file
        offset_file_path = os.path.join(
            instance.simulation_data.mfpath.get_sim_path(),
            "flopy_data_offset.pkl"
        )
        if os.path.exists(offset_file_path):
            with open(offset_file_path, "rb") as fd_ofp:
                instance.simulation_data.data_offset_location = \
                    pickle.load(fd_ofp)
    ...
    def write_simulation(
        ...
        # write data offset file
        offset_file_path = os.path.join(
            self.simulation_data.mfpath.get_sim_path(),
            "flopy_data_offset.pkl"
        )
        with open(offset_file_path, "wb") as fd_ofp:
            pickle.dump(sim_data.data_offset_location, fd_ofp)
